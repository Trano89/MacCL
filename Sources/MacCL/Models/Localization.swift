...
enum L10n {
    ...
    private static let table: [String: (fr: String, en: String, de: String, pt: String, es: String)] = [
        ...
        "transient_retry": ("Le modèle a mal formé un appel d'outil — nouvel essai (%@)", "The model malformed a tool call — retrying (%@)", "Das Modell hat einen Werkzeugaufruf falsch formatiert — neuer Versuch (%@)", "O modelo formatou mal uma chamada de ferramenta — a tentar de novo (%@)", "El modelo formó mal una llamada de herramienta — reintentando (%@)"),
