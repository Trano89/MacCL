...
enum L10n {
    ...
    private static let table: [String: (fr: String, en: String, de: String, pt: String, es: String)] = [
        ...
        "bridge_engine": ("Moteur de pont", "Bridge engine", "Brücken-Engine", "Motor de ponte", "Motor de puente"),
        "bridge_builtin": ("Routeur intégré", "Built-in router", "Integrierter Router", "Router integrado", "Enrutador integrado"),
        "bridge_builtin_x": ("Aucune dépendance. Récupère les appels d'outils émis en texte, streame le raisonnement en direct, agrandit le contexte automatiquement.", "No dependency. Recovers tool calls emitted as text, streams reasoning live, grows the context automatically.", "Keine Abhängigkeit. Stellt als Text ausgegebene Tool-Aufrufe wieder her, streamt Denkprozesse live, erweitert den Kontext automatisch.", "Sem dependências. Recupera chamadas de ferramentas emitidas como texto, transmite o raciocínio ao vivo, aumenta o contexto automaticamente.", "Sin dependencias. Recupera llamadas a herramientas emitidas como texto, transmite el razonamiento en vivo, amplía el contexto automáticamente."),
        "bridge_litellm_x": ("Pont de référence de la communauté, avec garde-fous réseau stricts — adapté à un Ollama distant sur un lien instable. Nécessite Python (installé automatiquement).", "The community's reference bridge, with strict network guard-rails — suited to a remote Ollama over a flaky link. Requires Python (installed automatically).", "Die Referenzbrücke der Community mit strengen Netzwerk-Schutzmechanismen — geeignet für ein entferntes Ollama über eine instabile Verbindung. Benötigt Python (wird automatisch installiert).", "A ponte de referência da comunidade, com proteções de rede rigorosas — adequada a um Ollama remoto numa ligação instável. Requer Python (instalado automaticamente).", "El puente de referencia de la comunidad, con salvaguardas de red estrictas — adecuado para un Ollama remoto con enlace inestable. Requiere Python (se instala automáticamente)."),
        "litellm_port": ("Port LiteLLM", "LiteLLM port", "LiteLLM-Port", "Porta do LiteLLM", "Puerto de LiteLLM"),
        "litellm_status": ("État de LiteLLM", "LiteLLM status", "LiteLLM-Status", "Estado do LiteLLM", "Estado de LiteLLM"),
        "litellm_install": ("Installer LiteLLM", "Install LiteLLM", "LiteLLM installieren", "Instalar o LiteLLM", "Instalar LiteLLM"),
        "litellm_installed": ("Installé", "Installed", "Installiert", "Instalado", "Instalado"),
        "litellm_not_installed": ("LiteLLM n'est pas installé — utilisez « Installer LiteLLM » dans les préférences.", "LiteLLM isn't installed — use “Install LiteLLM” in Preferences.", "LiteLLM ist nicht installiert — nutzen Sie „LiteLLM installieren“ in den Einstellungen.", "O LiteLLM não está instalado — use “Instalar o LiteLLM” nas preferências.", "LiteLLM no está instalado — usa “Instalar LiteLLM” en las preferencias."),
        "litellm_no_python": ("Aucun Python compatible trouvé (3.11–3.13 requis). Installez-le, par ex. : brew install python@3.12", "No compatible Python found (3.11–3.13 required). Install one, e.g.: brew install python@3.12", "Kein kompatibles Python gefunden (3.11–3.13 erforderlich). Installieren Sie z. B.: brew install python@3.12", "Nenhum Python compatível encontrado (3.11–3.13 necessário). Instale, por ex.: brew install python@3.12", "No se encontró un Python compatible (se requiere 3.11–3.13). Instala, p. ej.: brew install python@3.12"),
        "litellm_creating_venv": ("Création de l'environnement Python…", "Creating the Python environment…", "Python-Umgebung wird erstellt…", "A criar o ambiente Python…", "Creando el entorno de Python…"),
        "litellm_installing": ("Installation de LiteLLM (quelques minutes)…", "Installing LiteLLM (a few minutes)…", "LiteLLM wird installiert (einige Minuten)…", "A instalar o LiteLLM (alguns minutos)…", "Instalando LiteLLM (unos minutos)…"),
        "litellm_install_failed": ("L'installation de LiteLLM a échoué.", "LiteLLM installation failed.", "Die LiteLLM-Installation ist fehlgeschlagen.", "A instalação do LiteLLM falhou.", "La instalación de LiteLLM falló."),
        "litellm_install_ok": ("LiteLLM installé ✓", "LiteLLM installed ✓", "LiteLLM installiert ✓", "LiteLLM instalado ✓", "LiteLLM instalado ✓"),
        "litellm_config_failed": ("Écriture de la configuration LiteLLM impossible", "Could not write the LiteLLM config", "LiteLLM-Konfiguration konnte nicht geschrieben werden", "Não foi possível escrever a configuração do LiteLLM", "No se pudo escribir la configuración de LiteLLM"),
        "litellm_start_failed": ("Lancement de LiteLLM impossible", "Could not start LiteLLM", "LiteLLM konnte nicht gestartet werden", "Não foi possível iniciar o LiteLLM", "No se pudo iniciar LiteLLM"),
        "litellm_start_timeout": ("LiteLLM n'a pas démarré à temps.", "LiteLLM didn't start in time.", "LiteLLM ist nicht rechtzeitig gestartet.", "O LiteLLM não arrancou a tempo.", "LiteLLM no arrancó a tiempo."),
        ...
        "turn_lost_bridge_died": ("Le pont local s'est arrêté en plein tour — le tour est perdu, renvoyez votre message.", "The local bridge died mid-turn — the turn is lost, resend your message.", "Die lokale Brücke ist mitten im Zug abgestürzt — der Zug ist verloren, senden Sie Ihre Nachricht erneut.", "A ponte local parou a meio do turno — o turno perdeu-se, reenvie a sua mensagem.", "El puente local se detuvo en pleno turno — el turno se perdió, reenvíe su mensaje."),
        ...
        "ctx_max": ("Valeur maximale : 262144 (256k)", "Maximum value: 262144 (256k)", "Maximalwert: 262144 (256k)", "Valor máximo: 262144 (256k)", "Valor máximo: 262144 (256k)"),
